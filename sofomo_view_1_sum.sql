SELECT dataView.dimension1, dataView.dimesnion2, sum(dataView.measure_1) as measure1Sum, sum(dataView.measure_2) measure2Sum FROM
  (
  ...
  ) as dataView group by dataView.dimension1, dataView.dimesnion2